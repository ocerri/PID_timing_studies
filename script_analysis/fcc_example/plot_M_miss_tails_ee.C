...
TH1 *h_sum_ILD = new TH1F("h_sum_ILD","Missing Mass in Z#rightarrow e^{+}e^{-} tagged events (M_{Z}+/- 4 GeV)",60,40.0,160.0 );
TH1 *h_sum_CMS = new TH1F("h_sum_CMS","Missing Mass in Z#rightarrow e^{+}e^{-} tagged events (M_{Z}+/- 4 GeV)",60,40.0,160.0 );
...
TString paper2012_cuts = "dtheta_ll_lab>100&&Pt_ll>10&&Pl_ll<50&&acoplanarity_angle>10&&M_ll>87&&M_ll<95&&is_ee==1"; // modified cuts
