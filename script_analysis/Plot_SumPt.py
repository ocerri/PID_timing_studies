...
binning_mass = [(300-mass_lower_bound)/10, mass_lower_bound, 300.]
binning_sumPT =


bkg_file_path = glob('_root/jobs_PU140_poiss/pp2HardQCD_PU140_*/*evtV2*')

labels = []
production = {} # tracks in the mass spectrum per fb-1 of integrated lumi

c_sumPT = rt.TCanvas('c_sumPT', 'c_sumPT', 1600, 1600)

weight_sum = 0

for i, path in enumerate(bkg_file_path):
